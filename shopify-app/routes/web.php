...
Route::get('freegift/cart', function () {
    return view('freegift/cart');
});
Route::get('freegift/catalog', function () {
    return view('freegift/catalog');
});
Route::get('freegift/report', function () {
    return view('freegift/report');
});
Route::get('freegift/setting', function () {
    return view('freegift/setting');
});
